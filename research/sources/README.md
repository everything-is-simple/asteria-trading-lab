...
本仓库首轮只纳入轻量研究资料。以下原始材料仍保留在本地，不进入首轮仓库：
...
- `Z:\market-life-cycle\2012.(Japan)【立花义正】\台湾版-PDF转图片版`
...
- 只有当某份原始材料直接影响规则定义、事实裁决或回测可复现性时，才考虑纳入仓库。
- 大体量原始文件若后续需要入仓，优先评估是否使用 Git LFS。
